...
module.exports.userModelData = [
  {
    username: "WinterWatcher",
    email: "winterwatcher@seasonschange.com",
    password: "Fr@stGuard456!",
    isAdmin: false,
    likedMovies: [
      {
        imdbId: "tt1843866",
      ...
      {
        title: "Coldd Lassi Aur Chicken Masala",
        imdbId: "tt10044800",
        type: "series",
        hasWatched: false,
      },
  ...
  {
    username: "SummerDreamer",
    email: "summerdreamer@sunshinevibes.com",
    password: "Summ3rV!be2023",
    isAdmin: false,
    likedMovies: [
      {
        imdbId: "tt1022603",
      ...
      {
        title: "NFL Monday Night Football",
        imdbId: "tt0065323",
        type: "series",
        hasWatched: false,
      },
  ...
  {
    username: "WhaleTales",
    email: "whaletales@deepblue.com",
    password: "Blu3Fin@Whale",
    isAdmin: false,
    likedMovies: [
      {
        imdbId: "tt13833688",
      ...
      {
        title: "Super League: The War for Football",
        imdbId: "tt24587530",
        type: "series",
        hasWatched: false,
      },
      {
        title: "ESPN's Sunday Night Football",
        imdbId: "tt1136193",
        type: "series",
        hasWatched: false,
      },
      {
        title: "Football Hooligans International",
        imdbId: "tt1079234",
        type: "series",
        hasWatched: false,
      },
  ...
  {
    username: "CrayonFanatic",
    email: "crayonfanatic@cartoonmail.com",
    password: "Djbrdm@1357laddiedog",
    isAdmin: false,
    likedMovies: [
      {
        imdbId: "tt1609486",
      ...
      {
        imdbId: "tt26862791",
        title: "Shin Jigen! Crayon Shin-chan the Movie",
        hasWatched: false,
        type: "movie",
      },
      {
  ...
  },
  {
    ...
    email: "oceanexplorer@deepsea.com",
    password: "Djbrdm@1357laddiedog",
    isAdmin: false,
    likedMovies: [
      {
  ...
  },
  {
    ...
    email: "gamemaster77@funmail.com",
    password: "Djbrdm@1357laddiedog",
    isAdmin: false,
    likedMovies: [
      {
  ...
  },
  {
    ...
    email: "mysteryseeker@cluemail.com",
    password: "Djbrdm@1357laddiedog",
    isAdmin: false,
    likedMovies: [
      {
      ...
      {
        title: "Dinosaur Squadron Zyuranger",
        imdbId: "tt0103463",
        type: "series",
        hasWatched: true,
      },
  ...
  {
    username: "ActionFan001",
    email: "actionfan001@moviemail.com",
    password: "Djbrdm@1357laddiedog",
    isAdmin: false,
    likedMovies: [
      {
  ...
  {
    username: "DarkMovieLover",
    email: "darkmovies@cinemail.com",
    password: "Djbrdm@1357laddiedog",
    isAdmin: false,
    likedMovies: [
      {
  ...
  {
    username: "SleepyHollowFan",
    email: "sleepyhollow@moviebuffs.com",
    password: "Djbrdm@1357laddiedog",
    isAdmin: false,
    likedMovies: [
      {
      ...
      {
        title: "Nicki's Story - The Somber Chronicles",
        imdbId: "tt12412516",
        type: "series",
        hasWatched: true,
      },
  ...
  {
    username: "PenguinPal",
    email: "penguinpal@arcticmail.com",
    password: "Djbrdm@1357laddiedog",
    isAdmin: false,
    likedMovies: [
      {
      ...
      {
        title: "Honey's Story - The Somber Chronicles",
        imdbId: "tt14128586",
        type: "series",
        hasWatched: true,
      },
      ...
      {
        title: "Xena: Warrior Princess - A Friend in Need (The Director's Cut)",
        imdbId: "tt0817532",
        type: "series",
        hasWatched: true,
      },
  ...
  {
    username: "TrainRider",
    email: "trainrider@speedmail.com",
    password: "Djbrdm@1357laddiedog",
    isAdmin: false,
    likedMovies: [
      {
