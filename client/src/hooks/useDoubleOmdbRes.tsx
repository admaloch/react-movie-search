...
const useDoubleOmdbRes = () => {
  ...
  const [
    triggerPage1,
    {
      ...
      isSuccess: isSuccessPage1,
      isError: isErrorPage1,
      error: errorPage1,
    },
  ...
  const [
    triggerPage2,
    {
      ...
      isSuccess: isSuccessPage2,
      isError: isErrorPage2,
      error: errorPage2,
    },
  ] = useLazySearchMoviesQuery();
  ...
  const fetchSubmittedResults = async (searchInput: string) => {
    ...
    const firstPage = await triggerPage1({
      searchInput,
      currTypeParam,
      page: 1,
    });
    const secondPage = await triggerPage2({
      searchInput,
      currTypeParam,
      page: 2,
    });
