...
export default function ReviewIcons({
  imdbId,
  title,
}: ReviewProps): React.JSX.Element | null {
  ...
  return (
    <>
      <ReviewIcon reviewedMovie={reviewedMovie} imdbId={imdbId} title={title} />
      {reviewedMovie && <DeleteReviewIcon reviewId={reviewedMovie._id} />}
    </>
  );
}
