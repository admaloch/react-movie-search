...
export default function appendItem(item, text, destination, _class) {
    item.innerText = text;
...
export default function bioListeners(item, open, close, leave) {
...
export default function bioClick(info, btn) {
...
export default function titleLengthTest(input) {
...
export default function fade (input, opacity, display, height) {
    try {
